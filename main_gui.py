...
import reports
import utility
from data import Target, limbs_dict
from detector import Detector, target_detector

from VideoPlayer import VideoPlayer
from videoAnalysisDialog import VideoAnalysisDialog
from synchronyAnalysisDialog import SynchronyAnalysisDialog
from GenerateReportsDialog import GenerateReportsDialog
from SettingsWindow import SettingsWindow_Dialog
    ...
    def openSettings(self):
        ...
        if self.SettingsWindow.exec() == QtWidgets.QDialog.DialogCode.Accepted:
            if self.SettingsWindow.ui.checkBox_exportDirectory.isChecked():
                self.exportDirectory = self.SettingsWindow.ui.lineEdit.text()
            if self.SettingsWindow.ui.checkBox_defaultParams:
